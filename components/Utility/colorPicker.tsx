...
import { StyleSheet, View, Text, TouchableWithoutFeedback, TouchableOpacity, SafeAreaView } from "react-native";
import RBSheet from "react-native-raw-bottom-sheet";

const colors = ["#6874e7", "#b8304f", "#758E4F", "#fa3741", "#F26419", "#F6AE2D", "#DFAEB4", "#7A93AC", "#33658A", "#3d2b56", "#42273B", "#171A21"];
...
export default function Example() {
	...
	return (
		<SafeAreaView style={{ flex: 1 }}>
			...
			<RBSheet customStyles={{ container: styles.sheet }} height={440} openDuration={250} ref={sheet}>
